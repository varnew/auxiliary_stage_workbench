...
const UseForm = {
  ...
  render() {
    ...
    const renderItem = () => {
      return col ? this.rendeColFormItem(modelRender, col) : modelRender.map((item) => {
    ...
    return (
      <a-form-model ref={ref} class={{ 'custom-form': true, 'render-form': this.isRender, 'drag-form': this.isDrag }} {...{ props: { ...modelProps } }}>
